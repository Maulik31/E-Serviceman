...
<head>
<meta charset="utf-8">
<title>E-Serviceman | Join us</title>
...
<div id="wrapper" class="home-page">
	...
	<!-- end header -->
	<div class="container">
		<h1 class="well" align="center" style="background-color:#ffc02a ">Technician Registration Form</h1>
		<div class="col-lg-12 well">
			<div class="row">
				<form action="creg" method="post" enctype="multipart/form-data">
					<div class="col-sm-12">
						<div id="row">
       ...
       title="Phone number with 7-9 and remaing 9 digit with 0-9" required="required">
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								<label>Company</label> <input type="text" name="company"
									placeholder="Enter Company Name Here.." class="form-control"required="required">
							</div>
							<div class="form-group">
								<div class="col-sm-6 form-group">
									<label for="sel1">Service</label> <select class="form-control"
						...
						<div class="form-group">
							<label>Client Image</label> <input type="file" name="cimage" required="required">
						</div>
						<div class="row">
							<div class="col-sm-6 form-group">
							...
							<div class="form-group">
								<div class="col-sm-6 form-group">
									<p>
										Already Registered with us? <a href="clientLogin.jsp"
